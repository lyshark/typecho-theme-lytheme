...
class BlockIP_Plugin implements Typecho_Plugin_Interface
{
    ...
    {
        $ips = new Typecho_Widget_Helper_Form_Element_Textarea('ips', null, null, _t('IP黑名单列表'), _t('一行一个，支持规则<br>以下是例子<br>192.168.1.1<br>210.10.2.1-20<br>222.34.4.*<br>218.192.104.*'));
        $form->addInput($ips);
    ...
    public static function blockIP()
    {
        if (BlockIP_Plugin::checkIP()) {
            ...
            throw new Typecho_Widget_Exception('抱歉，您的整个网段已被永久禁止访问。');
        }
